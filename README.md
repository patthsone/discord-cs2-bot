...
The bot includes a built-in status page that shows real-time statistics about bot usage, server count, and feature utilization.

Бот включает встроенную статус-страницу, которая показывает статистику использования бота в реальном времени, количество серверов и использование функций.

Бот включає вбудовану статус-сторінку, яка показує статистику використання бота в реальному часі, кількість серверів та використання функцій.
